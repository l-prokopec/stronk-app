...
describe('uživatelské chování', () => {
  ...
  it('zobrazí horní gradient až po odscrollování', () => { Object.defineProperty(window, 'scrollY', { configurable: true, value: 16 }); renderApp(); window.dispatchEvent(new Event('scroll')); expect(document.documentElement).toHaveClass('has-scrolled'); Object.defineProperty(window, 'scrollY', { configurable: true, value: 0 }); window.dispatchEvent(new Event('scroll')); expect(document.documentElement).not.toHaveClass('has-scrolled') })
