export type AppHistoryState =
  ...
  | { app: 'stronk-app'; screen: 'settings' }
...
export const SETTINGS_HISTORY_STATE: AppHistoryState = { app: 'stronk-app', screen: 'settings' }
...
export const isAppHistoryState = (value: unknown): value is AppHistoryState => {
  ...
  if (value.screen === 'home' || value.screen === 'templates' || value.screen === 'settings') return true
...
export const pushSettingsHistory = (): void => window.history.pushState(SETTINGS_HISTORY_STATE, '', currentUrl())
