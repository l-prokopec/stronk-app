...
describe('uživatelské chování', () => {
  ...
  it('přepne a zapamatuje tmavý motiv', async () => { const user = userEvent.setup(); localStorage.setItem('stronk-app:theme', 'light'); renderApp(); await user.click(screen.getByRole('button', { name: 'Přepnout na tmavý režim' })); expect(document.documentElement).toHaveAttribute('data-theme', 'dark'); expect(localStorage.getItem('stronk-app:theme')).toBe('dark'); expect(screen.getByRole('button', { name: 'Přepnout na světlý režim' })).toBeInTheDocument() })
