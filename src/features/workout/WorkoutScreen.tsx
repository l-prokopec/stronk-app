  ...
  return <main className="workout-screen">
    ...
    <div className="workout-screen__content">
      ...
      <section className="exercise-list workout-exercises" aria-label="Cviky">
        {workout.exercises.length === 0 ? <EmptyState title="Trénink nemá žádné cviky">Přidejte vlastní cvik a začněte zapisovat série.</EmptyState> : workout.exercises.map((exercise) => <ExerciseCard key={exercise.id} workoutId={workout.id} exercise={exercise} people={workout.people} />)}
      </section>
