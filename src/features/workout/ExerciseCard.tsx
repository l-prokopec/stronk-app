...
export function ExerciseCard({ workoutId, exercise, dragHandle, expanded, onToggle, onComplete, onReopen }: { workoutId: string; exercise: WorkoutExercise; dragHandle: DragHandleProps; expanded: boolean; onToggle: () => void; onComplete: () => void; onReopen: () => void }) {
