...
export const appReducer = (state: AppState, action: AppAction): AppState => {
  switch (action.type) {
    case 'CREATE_WORKOUT': { const workout = createWorkout(state, action.now); return { ...state, workouts: [...state.workouts, workout], activeWorkoutId: workout.id } }
